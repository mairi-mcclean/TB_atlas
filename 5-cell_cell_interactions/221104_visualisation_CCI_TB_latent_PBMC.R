...
cellchat <- readRDS('/Users/carlos.lopez/INBOX/tb_circuits/cellchat_objects/CaiY_latentTB-PBMC_cellchat.log.rds')
cellchat
...
gg2 <- netAnalysis_signalingRole_scatter(cellchat, signaling = c("VISFATIN", "MHC-I"))
gg1 + gg2
