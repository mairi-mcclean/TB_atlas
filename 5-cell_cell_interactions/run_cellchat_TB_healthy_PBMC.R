...
ad_object <- ad$read_h5ad('/Users/carlostalavera-lopez/Downloads/CaiY_Healthy-PBMC_cellchat-ready.log.h5ad')
...
saveRDS(cellchat, file = "/Users/carlostalavera-lopez/Downloads/CaiY_Healthy-PBMC_cellchat.rds")
sessionInfo()
